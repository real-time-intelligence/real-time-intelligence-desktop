...
public class GanttTable extends SplitLayeredHolder {
	...
	public GanttTable(Object rowData[][], Object columnNames[][], ComponentList componentList, Map<String, Color> seriesColorMap)
	{
		this(JTableHelper.createTableModel(rowData, columnNames), componentList, columnNames, seriesColorMap);
	}
