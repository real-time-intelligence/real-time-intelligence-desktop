...
@Log4j2
public class GanttDataPanel extends JPanel implements ListSelectionListener {
    ...
    public GanttDataPanel(WorkspaceQueryComponent workspaceQueryComponent,  QueryInfo queryInfo,
        TableInfo tableInfo, CProfile cProfile, long begin, long end, Map<String, Color> seriesColorMap) {
                ...
                executorService.submit(() -> {
                    ...
                    try {
                        CProfile firstLevelGroupBy = tableInfo.getCProfiles().stream()
                            ...
                            ganttColumnList.forEach(ganttColumn -> { // todo need to enable logging dynamically
